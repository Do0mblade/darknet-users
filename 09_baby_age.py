...
# 1. Данную задачу надо выложить с помощью git (с локального устройства)
# 2. Решение 1 должно быть БЕЗ использования функции
# 3. Решение 2 должно быть представлено в виде функции
